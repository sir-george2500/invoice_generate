              ...
              <Form className="space-y-6">
                {error && (
                  <div className="bg-red-50 border-2 border-red-200 rounded-lg p-4 flex items-center space-x-2">
                    ...
                    <span className="text-sm text-red-800 font-medium">{error.message}</span>
                  </div>
                )}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Field
                      ...
                      name="username"
                      type="text"
                      className={`block w-full pl-10 pr-3 py-3 text-gray-900 bg-white border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-500 transition-colors ${
                  ...
                  <ErrorMessage name="username" component="div" className="mt-1 text-sm text-red-600 font-medium" />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Field
                      ...
                      className={`block w-full pl-10 pr-10 py-3 text-gray-900 bg-white border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-500 transition-colors ${
